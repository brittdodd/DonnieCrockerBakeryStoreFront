        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BakeryProduct>(entity =>
            {
                entity.HasKey(e => e.ProductId)
                    .HasName("PK_BakeryProducts_1");

                entity.Property(e => e.ProductId).HasColumnName("ProductID");

                entity.Property(e => e.BakeryItems)
                    .HasMaxLength(200)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.SeaonalId).HasColumnName("SeaonalID");

                entity.HasOne(d => d.Category)
                    .WithMany(p => p.BakeryProducts)
                    .HasForeignKey(d => d.CategoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_BakeryProducts_Categories");

                entity.HasOne(d => d.Seaonal)
                    .WithMany(p => p.BakeryProducts)
                    .HasForeignKey(d => d.SeaonalId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_BakeryProducts_Seasons");
            });
            ...
            modelBuilder.Entity<OrderProduct>(entity =>
            {
                ...
                entity.HasOne(d => d.Product)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_OrderProducts_BakeryProducts");
            });
